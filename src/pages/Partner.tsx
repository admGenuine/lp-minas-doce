...
const WA_CATALOG = 'https://wa.me/5531987654321?text=Ol%C3%A1%2C+gostaria+de+receber+o+cat%C3%A1logo+completo+da+Minas+Doce.'
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                className="border border-secondary text-secondary px-8 py-4 rounded-xl font-label-sm text-label-sm uppercase tracking-widest hover:bg-surface-variant transition-colors inline-flex items-center gap-2"
              >
